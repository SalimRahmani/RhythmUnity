...
def loadJSON(file):
	MembersTimeSlots=open(file) #Open the Json File
	data = json.load(MembersTimeSlots) #Load the timeslots with members into data variable
	MembersTimeSlots.close() #close the file
	return data
